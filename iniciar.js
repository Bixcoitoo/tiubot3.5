...
const API_KEY_ALEATORY = "maria1316";
...
conn.sendMessage(mdata_2.id, {image: {url:`http://br3.bronxyshost.com:3039/welcome?titulo=BEM%20VINDO(A)&nome=${ale2.participants[0].split('@')[0]}&perfil=${shortpc.data}&fundo=${fundo1}&grupo=BEM VINDO AO GRUPO ${encodeURI(mdata_2.subject)}`},
...
conn.sendMessage(mdata_2.id, {image: {url:`http://br3.bronxyshost.com:3039/welcome?titulo=Adeus&nome=${ale2.participants[0].split('@')[0]}&perfil=${shortpc.data}&fundo=${fundo2}&grupo=SAIU DE ${encodeURI(mdata_2.subject)}`}, caption: teks, 
